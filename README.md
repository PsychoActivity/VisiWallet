...
# General Usage Notes
1. It is actually safe to share the images onto social media networks.  Social networks such as Facebook, Instagram, Twitter preprocess and compress all images uploaded to their servers, permanantly altering the original sequence of data that was computed to generate the wallet during the process. The original photograph is unaffected by this procedure.
